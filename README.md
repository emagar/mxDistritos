...
1.  [Description of *Recent Mexican federal election geography* repository](#orgc5aa1f9)
2.  [Files in the repository and how to cite them](#org076d2cb)
3.  [Acknowledgements](#org15745a5)
4.  [below are elements to copy/emulate in this readme file ---](#org2cd5acc)
5.  [Files in the repository and how to cite them](#org59055fb)
6.  [Codebook](#orgcc195fc)
7.  [Coding procedure for the incumbent's status](#orgf64dc00)
8.  [Procedimiento para codificar el estatus del ocupante](#org3fda000)
9.  [Sources](#orgffbacce)
...
-   *race.after* = incumbent's status in the subsequent race. See [this](#orgb9d5b0b) for categories and coding procedure ([aquí](#org14bdb86) la versión en español del procedimiento codificador).


<a id="orgf64dc00"></a>

# Coding procedure for the incumbent's status<a id="orgb9d5b0b"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org14bdb86"></a>
