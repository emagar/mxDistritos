...
## mex2$munn <- NULL
## colnames(mex2) <- c("seccion","disn1996")
## 
...
## head(mex)
## 
## write.csv(mex, file = "fuenteAlumnos/mexLoc.csv", row.names = FALSE)
 
## # hidalgo
## colnames(hgo1)
## hgo1 <- hgo1[,c("edon","seccion","munn","escenario3_cg","escenario3_jge")]
## colnames(hgo1) <- c("edon","seccion","munn","disn2016cg","disn2016jge")
## table(hgo1$disn2016cg, hgo1$disn2016jge) # martha reporta q se aprobó escen alterno derfe --> interpreto que se trata de jge VERIFICAR!!
## colnames(hgo1) <- c("edon","seccion","munn","disn2016cg","disn2016")
## hgo1$disn2016cg <- NULL
## 
## # cambia nombres en datos de Claudia
## colnames(hgo2)
...
## # oaxaca
## colnames(oax1)
## oax1 <- oax1[,c("edon","seccion","munn","escenario3_cg","escenario3_jge","escenario3_tribunal")]
## colnames(oax1) <- c("edon","seccion","munn","disn2016cg","disn2016jge","disn2018")
## table(oax1$disn2016cg, oax1$disn2016jge)
## table(oax1$disn2016cg, oax1$disn2018) # el bueno es el del cg (menos discrepancias c 2018), como dice documento Martha
## colnames(oax1) <- c("edon","seccion","munn","disn2016","disn2016jge","disn2018")
## oax1$disn2016jge <- NULL
...
## write.csv(oax, file = "fuenteAlumnos/oaxLoc.csv", row.names = FALSE)
...
##     return(what)
## }
## d <- rename.col(old="disn1996", new="disloc1996", what=d)
## d <- rename.col(old="disn2018", new="disloc2018", what=d)
## #
## # ---> NOTE:                                                                         <--- #
## # ---> open useEqPrep2fillMissSeccionesLocalMaps.r and run manually to spot errors   <--- #
