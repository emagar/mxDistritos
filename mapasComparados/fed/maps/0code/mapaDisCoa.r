...
mapKeyPink <- function(dn = NULL){
    ...
    plot(p84(ed.map$coa), col = "white", axes = TRUE, main = "Coahuila (distritos federales 2018)", bg = "lightblue")
    plot(p84(ed.map$cua), col = "white", add = TRUE, lty = 3)
    plot(p84(ed.map$dgo), col = "white", add = TRUE, lty = 3)
    plot(p84(ed.map$zac), col = "white", add = TRUE, lty = 3)
    plot(p84(ed.map$nl), col = "white", add = TRUE, lty = 3)
    plot(p84(ed.map$tam), col = "white", add = TRUE, lty = 3)
    plot(p84(ed.map$san), col = "white", add = TRUE, lty = 3)
    # 
...
mapOneDistrito <- function(dn = NULL, what2plot = NULL){
    ...
    plot(df.map[df.map$disfed==dn,], axes = TRUE, main = paste("Coahuila ", dn, " - ", tmp, sep = ""))
    plot(bg, add = TRUE)
...
mapKeyPink(2)
mapOneDistrito(dn = 7, what2plot = 1)
