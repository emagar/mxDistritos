...
mapKeyPink <- function(dn = NULL){
    ...
    plot(p84(ed.map$ags), col = "white", axes = TRUE, main = "Aguascalientes (distritos federales 2018)")#, bg = "lightblue")
    ...
    # thick state border
    plot(p84(ed.map$ags), add = TRUE, lwd = 3)
    plot(p84(ed.map$ags), add = TRUE, border = "red", lty = 3, lwd = 2)
