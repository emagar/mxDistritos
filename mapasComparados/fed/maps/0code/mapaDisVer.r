...
mapKeyPink <- function(dn = NULL){
    ...
    plot(p84(ed.map$ver), col = "white", axes = TRUE, main = "Veracruz (distritos federales 2018)", bg = "lightblue")
    ...
    plot(p84(ed.map$tla), col = "white", add = TRUE, lty = 3)
    ...
    plot(p84(ed.map$cps), col = "white", add = TRUE, lty = 3)
    ...
    # thick state border
    plot(p84(ed.map$ver), add = TRUE, lwd = 3)
    plot(p84(ed.map$ver), add = TRUE, border = "red", lty = 3, lwd = 2)
