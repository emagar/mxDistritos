...
##################
write.csv(out.y1988,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-1988.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y1991,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-1991.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y1994,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-1994.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y1997,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-1997.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y2000,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-2000.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y2003,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-2003.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y2006,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-2006.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y2009,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-2009.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y2012,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-2012.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y2015,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-2015.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y2018,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-2018.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y2021,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-2021.csv", sep = ""), row.names = FALSE)
##
write.csv(out.y2024,
          file = paste(wd, "data/distrito/dipfed-distrito-vhat-2024.csv", sep = ""), row.names = FALSE)
##

## save district regression objects
save(mean.regs.d79, file = paste(wd, "data/distrito/dipfed-distrito-mean-regs-map1979.RData", sep = ""), compress = c("gzip", "bzip2", "xz")[3])
save(mean.regs.d97, file = paste(wd, "data/distrito/dipfed-distrito-mean-regs-map1997.RData", sep = ""), compress = c("gzip", "bzip2", "xz")[3])
save(mean.regs.d06, file = paste(wd, "data/distrito/dipfed-distrito-mean-regs-map2006.RData", sep = ""), compress = c("gzip", "bzip2", "xz")[3])
save(mean.regs.d18, file = paste(wd, "data/distrito/dipfed-distrito-mean-regs-map2018.RData", sep = ""), compress = c("gzip", "bzip2", "xz")[3])
##
save(regs.1988, file = paste(wd, "data/distrito/dipfed-distrito-regs-1988.RData", sep = ""), compress = "gzip")
save(regs.1991, file = paste(wd, "data/distrito/dipfed-distrito-regs-1991.RData", sep = ""), compress = "gzip")
save(regs.1994, file = paste(wd, "data/distrito/dipfed-distrito-regs-1994.RData", sep = ""), compress = "gzip")
save(regs.1997, file = paste(wd, "data/distrito/dipfed-distrito-regs-1997.RData", sep = ""), compress = "gzip")
save(regs.2000, file = paste(wd, "data/distrito/dipfed-distrito-regs-2000.RData", sep = ""), compress = "gzip")
save(regs.2003, file = paste(wd, "data/distrito/dipfed-distrito-regs-2003.RData", sep = ""), compress = "gzip")
save(regs.2006, file = paste(wd, "data/distrito/dipfed-distrito-regs-2006.RData", sep = ""), compress = "gzip")
save(regs.2009, file = paste(wd, "data/distrito/dipfed-distrito-regs-2009.RData", sep = ""), compress = "gzip")
save(regs.2012, file = paste(wd, "data/distrito/dipfed-distrito-regs-2012.RData", sep = ""), compress = "gzip")
save(regs.2015, file = paste(wd, "data/distrito/dipfed-distrito-regs-2015.RData", sep = ""), compress = "gzip")
save(regs.2018, file = paste(wd, "data/distrito/dipfed-distrito-regs-2018.RData", sep = ""), compress = "gzip")
save(regs.2021, file = paste(wd, "data/distrito/dipfed-distrito-regs-2021.RData", sep = ""), compress = "gzip")
save(regs.2024, file = paste(wd, "data/distrito/dipfed-distrito-regs-2024.RData", sep = ""), compress = "gzip")
